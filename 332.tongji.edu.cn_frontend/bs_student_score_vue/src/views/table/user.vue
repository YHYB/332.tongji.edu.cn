  ...
  <div>
    ...
    <el-form :inline="true">
      <el-form-item label="用户名">
        <el-input placeholder="用户名" size="small" v-model="searchMap.username"></el-input>
      </el-form-item>
    ...
    <el-dialog :visible.sync="dialogFormVisible" title="编辑" width="40%">
      <el-form label-width="100px" style="margin-right: 30px">
        <el-form-item label="用户名">
          <el-input size="medium" v-model="pojo.username"></el-input>
        </el-form-item>
        <el-form-item label="密码">
          <el-input size="medium" v-model="pojo.password"></el-input>
        </el-form-item>
    ...
    <el-dialog :visible.sync="dialogUploadVisible" title="批量导入" width="40%">
      <el-upload
        ...
        action="http://localhost:9999/demo/user/importExcel/"
        class="upload-demo"
        ref="upload">
