  ...
  <div>
    ...
    <el-form :inline="true">
      ...
      <el-form-item label="班级">
        <el-input placeholder="班级" size="small" v-model="searchMap.class_info"></el-input>
      </el-form-item>
    ...
    <el-table
      ...
      <el-table-column label="班级" prop="class_info"></el-table-column>
    ...
    <el-dialog :visible.sync="dialogFormVisible" title="编辑" width="40%">
      <el-form label-width="100px" style="margin-right: 30px">
        ...
        <el-form-item label="班级">
          <el-input size="medium" v-model="pojo.class_info"></el-input>
        </el-form-item>
    ...
    <el-dialog :visible.sync="dialogUploadVisible" title="批量导入" width="40%">
      <el-upload
        ...
        action="http://localhost:9999/demo/student/importExcel/"
        class="upload-demo"
        ref="upload">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleSave() {
        studentApi.update(this.id, this.pojo).then(response => {
          this.$message({
